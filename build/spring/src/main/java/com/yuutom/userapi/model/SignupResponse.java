...
public class SignupResponse {
  ...
  public SignupResponse message(String message) {
  ...
  @Schema(name = "message", example = "Account successfully created", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public SignupResponse user(User user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, signupResponse.message) &&
        Objects.equals(this.user, signupResponse.user);
  }
